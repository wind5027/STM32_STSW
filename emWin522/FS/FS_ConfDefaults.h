...
#ifndef __FS_CONFDEFAULTS_H__               // Avoid recursive and multiple inclusion
#define __FS_CONFDEFAULTS_H__
...
*/
  ...
  #define FS_SUPPORT_READ_AHEAD         0   // When set to 1 the file system activates the FS_READAHEAD_Driver to read sectors in advance
                                            // in advance during allocation table search operations.
#endif
