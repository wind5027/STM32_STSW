...
**********************************************************************
*/
#define ALLOC_SIZE                 0xCA00      // Size defined in bytes
#define RAMDISK_NUM_SECTORS            92      //
...
*/
  ...
  static __no_init U32 _aMemBlock[ALLOC_SIZE / 4]; // Memory pool used for semi-dynamic allocation.
#endif
#ifdef __GNUC__
  static U32 _aMemBlock[ALLOC_SIZE / 4] __attribute__ ((section (".sram"))); // Memory pool used for semi-dynamic allocation.
#else
