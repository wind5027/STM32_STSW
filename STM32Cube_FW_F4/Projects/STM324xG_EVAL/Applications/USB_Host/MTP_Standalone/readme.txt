...
Then the Host detects the number of storage devices and displays on the LCD screen. User needs to select
between phone and SD card using Joystick buttons. If MTP device support only 1 storage, the user needs 
to select that storage.
