/**
  ...
  * @brief   Description of the STM32F4xx LCD Paint example.
  ******************************************************************************
  *
...
@par Directory contents
    ...
    - Display/LCD_Paint/Inc/main.h                      Main config file
    - Display/LCD_Paint/Inc/stm32f4xx_it.h              Header for stm32f4xx_it.c
    - Display/LCD_Paint/Inc/stm32f4xx_conf.h            library configuration file 
    ...
    - Display/LCD_Paint/Src/ts_calibration.c            touch screen calibration driver
...
@par Hardware and Software environment
  ...
  - STM324xG-EVAL Set-up
   ...
   @note Make sure that jumper JP16 is in position MSD.
