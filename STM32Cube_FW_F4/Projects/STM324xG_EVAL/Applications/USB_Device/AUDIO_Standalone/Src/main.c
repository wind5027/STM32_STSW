...
static void SystemClock_Config(void)
{
  ...
  RCC_PeriphCLKInitTypeDef RCC_PeriphInitStruct;
  ...
  RCC_PeriphInitStruct.PeriphClockSelection = RCC_PERIPHCLK_I2S;
  RCC_PeriphInitStruct.PLLI2S.PLLI2SN = 258;
  RCC_PeriphInitStruct.PLLI2S.PLLI2SR = 3;
