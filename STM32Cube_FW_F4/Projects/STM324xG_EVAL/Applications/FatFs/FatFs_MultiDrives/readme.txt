...
@par Directory contents
  ...
  - FatFs/FatFs_MultiDrives/Inc/main.h                  Header for main.c module
  ...
  - FatFs/FatFs_MultiDrives/Src/system_stm32f4xx.c      STM32F4xx system source file
...
@par Hardware and Software environment
  ...
  - STM324xG-EVAL Set-up
   - Connect a uSD Card to the MSD connector (CN6).
     @note Make sure that jumpers JP16 and JP22 are in position 1-2.
