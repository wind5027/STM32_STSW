...
static const GUI_WIDGET_CREATE_INFO _aDialog[] = 
{
  ...
  { FRAMEWIN_CreateIndirect, "System", ID_FRAMEWIN_INFO, 0, 0, 640, 454, 0, 0x64, 0 },
  { IMAGE_CreateIndirect, "Image", ID_IMAGE_INFO, 480, 92, 160, 160, 0, 0, 0 },
  { BUTTON_CreateIndirect, "Exit", ID_BUTTON_INFO_CLOSE, 456, 247, 140, 140, 0, 0x0, 0 },
  { MULTIPAGE_CreateIndirect, "Multipage", ID_MULTIPAGE, 18, 42, 393, 342, 0, 0x0, 0 },  
};

static const GUI_WIDGET_CREATE_INFO _aDialogSystemInformation[] = {
  { WINDOW_CreateIndirect, "System Information", 0, 0,   0, 393, 342, FRAMEWIN_CF_MOVEABLE },
  { TEXT_CreateIndirect, "Board : STM324x9I", ID_TEXT_BOARD, 40, 24, 300, 50, 0, 0x0, 0 },
  { TEXT_CreateIndirect, "Core: STM32F439", ID_TEXT_CORE, 40, 54, 300, 50, 0, 0x0, 0 },
  { TEXT_CreateIndirect, "CPU Speed : up to 180MHz", ID_TEXT_CPU, 40, 84, 300, 20, 0, 0x0, 0 },
  { TEXT_CreateIndirect, "Firmware Version : 1.0", ID_TEXT_VERSION, 40, 114, 300, 20, 0, 0x0, 0 },
  { IMAGE_CreateIndirect, "Image", ID_IMAGE_LOGO, 170, 260, 40, 20, 0, 0, 0 },  
  { TEXT_CreateIndirect, "Copyright (c) STMicroelectronics 2014", ID_TEXT_COPYRIGHT, 40, 290, 320, 20, 0, 0x0, 0 },  
};

static const GUI_WIDGET_CREATE_INFO _aDialogGeneralSettings[] = {
  { WINDOW_CreateIndirect, "General Settings", 0, 0, 0, 393, 342, FRAMEWIN_CF_MOVEABLE },
  { CHECKBOX_CreateIndirect, "Checkbox", ID_CHECKBOX_SPRITES, 26, 30, 160, 20, 0, 0x0, 0 },
  { CHECKBOX_CreateIndirect, "Checkbox", ID_CHECKBOX_BACKGROUND, 26, 70, 227, 20, 0, 0x0, 0 },
  { CHECKBOX_CreateIndirect, "Checkbox", ID_CHECKBOX_CPU180, 26, 110, 215, 20, 0, 0x0, 0 },
  { CHECKBOX_CreateIndirect, "Checkbox", ID_CHECKBOX_FLEXSKIN, 26, 150, 180, 20, 0, 0x0, 0 },
...
static const GUI_WIDGET_CREATE_INFO _aDialogClockSettings[] = {
  { WINDOW_CreateIndirect, "Clock Settings", 0, 0, 0, 393, 342, FRAMEWIN_CF_MOVEABLE },
  { SPINBOX_CreateIndirect, "Spinbox", ID_SPINBOX_HOUR, 244, 210, 37, 30, 0, 0x0, 0 },  
  { SPINBOX_CreateIndirect, "Spinbox", ID_SPINBOX_MINUTE, 289, 210, 37, 30, 0, 0x0, 0 },
  { SPINBOX_CreateIndirect, "Spinbox", ID_SPINBOX_SEC, 337, 210, 37, 30, 0, 0x0, 0 },
  { BUTTON_CreateIndirect, "Apply settings", ID_BUTTON_APPLYSETTINGS, 245, 240, 129, 50, 0, 0x0, 0 },
};
...
static void _cbClockSettings(WM_MESSAGE * pMsg) {
  ...
  case WM_PAINT:
    ...
    {
      k_GetTime(&Time);   
      GUI_UpdateClock (310, 150, Time.Hours, Time.Minutes, Time.Seconds);
