...
{
  { FRAMEWIN_CreateIndirect, "File Browser", ID_FRAMEWIN, 0, 0, 640, 454, 0, 0x64, 0 },
  { BUTTON_CreateIndirect, "Refresh", ID_BUTTON_REFRESH, 525, 390, 95, 35, 0, 0x0, 0 },
  { TREEVIEW_CreateIndirect, "Treeview", ID_TREEVIEW, 7, 6, 495, 420, 0, 0x0, 0 }, 
...
static int _ShowMessageBox(WM_HWIN hWin, const char* pTitle, const char* pText, int YesNo) 
{
  ...
  int r = 0;
  /* Create frame win */
  hFrame = FRAMEWIN_CreateEx(200, 150, 190, 90, hWin, WM_CF_SHOW, FRAMEWIN_CF_MOVEABLE, 0, pTitle, &_cbMessageBox);
