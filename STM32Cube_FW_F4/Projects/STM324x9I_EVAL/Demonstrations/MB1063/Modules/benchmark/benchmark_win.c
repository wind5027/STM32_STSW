...
{
  { FRAMEWIN_CreateIndirect, "Benchmark", ID_FRAMEWIN_INFO, 0, 0, 640, 454, 0, 0x64, 0 },
  { TEXT_CreateIndirect, "  00000000 Pixels/s ", ID_BENCH_CPU, 155, 280, 154, 32, 0, 0, 0 }, 
  { BUTTON_CreateIndirect, "Start Speed Benchmark", ID_BENCH_CPU, 100, 350, 236, 48, 0, 0, 0 },
...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  case WM_INIT_DIALOG:
    ...
    hItem = TEXT_CreateEx(20, 25, 113, 20, pMsg->hWin, WM_CF_SHOW,0, 0x123,"");
    ...
    hGraph = GRAPH_CreateEx(20, 45, 388, 205, pMsg->hWin, WM_CF_SHOW, 0, GUI_ID_GRAPH0);
