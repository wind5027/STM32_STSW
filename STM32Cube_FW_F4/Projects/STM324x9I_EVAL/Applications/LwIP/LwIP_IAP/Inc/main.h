...
/* 
   ...
   compiler v6.70, with high optimization for size, is 55826 bytes (42218 bytes
   of readonly code memory and 13608 bytes of readonly data memory).
   Based on this result four sectors of 16 Kbytes each will be used to store 
   the IAP code, so the user Flash address will start from Sector4. 
